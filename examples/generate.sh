...
xyzrender "$DIR/caffeine.xyz" --config graph -o "$IMG/caffeine_graph.svg"
...
xyzrender "$DIR/mnh.xyz" -o "$IMG/mnh_haptic.svg" --haptic
xyzrender "$DIR/mnh.xyz" -o "$IMG/mnh.svg"
...
xyzrender "$DIR/triphenylbenzol.xyz" --ensemble --ensemble-color cpk -o "$IMG/triphenylbenzol_ensemble_cpk.svg"
